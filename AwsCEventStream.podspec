Pod::Spec.new do |spec|
  spec.name          = "AwsCEventStream"
  spec.version       = "0.36.0"
  spec.summary       = "AWS Common Runtime Event Stream Library"
  ...
  spec.source_files  = "aws-common-runtime/aws-c-event-stream/**/*.{h,c}"
  spec.public_header_files = "aws-common-runtime/aws-c-event-stream/**/*.h"
